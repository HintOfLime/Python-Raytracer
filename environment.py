...
spheres = [ Sphere(Vector3(-140.0, -60.0, 160), 60.0, Texture("white.png", "plate.jpg"), 1.0, 1.0, 0.9),
            Sphere(Vector3(0.0, -100.0, 0.0), 50.0, Texture("earth.bmp", "rough.png"), 1.0, 1.0, 0.0)
          ]

planes =  [ Plane(Vector3(0.0, 0.0, 0.0), Vector3(0, -1.0, 0.0), Grid(), 0.5, 0.3, 0.2),
